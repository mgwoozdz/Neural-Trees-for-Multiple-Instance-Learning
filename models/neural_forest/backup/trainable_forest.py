# %%
from neural_forest import Forest
...
forest = Forest(n_tree=n_tree, tree_depth=tree_depth, n_in_feature=784,
...
trainable = TrainableForest(forest, Config())

# %%
optim = torch.optim.Adam(trainable.get_params(), lr=0.01)
...
db = {'train': train_dataset, 'eval': eval_dataset}

# %%
trainable.train(optim, db)
