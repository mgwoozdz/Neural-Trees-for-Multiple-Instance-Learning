"""Pytorch Dataset object that loads 25x25 patches that contain single cells."""
...
class ColonCancerBagsCross(data_utils.Dataset):
    ...
    def create_bags(self, dir_list):
        ...
        for dir in dir_list:
            ...
            bag = view_as_blocks(img, block_shape=(25, 25, 3)).reshape(-1, 25, 25, 3)

            # store single cell labels

            label = 1 if 'epithelial' in dir else 0
